...
const readPdf = pdfBuffer => {
  ...
  const refTable = (0, _readRefTable.default)(pdfBuffer, xRefPosition);
  ...
  if (refTable.maxOffset > xRefPosition) {
    throw new _SignPdfError.default('Ref table is not at the end of the document. This document can only be signed in incremental mode.', _SignPdfError.default.TYPE_PARSE);
  }
